  ...
  import 'package:dislexia_go/kayitSayfasi.dart';
  ...
  void main() async {
    ...
    runApp(MyApp(temaRenk: temaRenk));
  }

  class MyApp extends StatelessWidget {
    final Color temaRenk;

    const MyApp({super.key, required this.temaRenk});
    ...
    Widget build(BuildContext context) {
      return MaterialApp(
        ...
        theme: ThemeData(
          primarySwatch: temaRenk == Colors.blueAccent ? Colors.blue : Colors.deepPurple,
          scaffoldBackgroundColor: temaRenk.withOpacity(0.08), // arka plan rengi
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Kayitsayfasi()));
                        setState(() {
                          durum=false;
                        });
                      },
  ...
  class SesYonetici {
    ...
    static String? _aktifDosya;
    static bool _caliyor = false;
    static Future<void> sesAyarla(double seviye) async {
      await _player.setVolume(seviye);
    }

    static Future<void> baslat(String yeniDosya) async {

      if (_aktifDosya == yeniDosya && _caliyor) return;

      await _player.stop();
      _aktifDosya = yeniDosya;
      await _player.setReleaseMode(ReleaseMode.loop);
      await _player.play(AssetSource('arkaplanmusic/$yeniDosya'));
      _caliyor = true;
    }
